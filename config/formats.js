...
exports.Formats = [
...

	{
		...
		onSwitchIn: function (pokemon) {
			...
			if (name === 'a') {
				this.add("c|+A|No, my name doesn't HL whenever someone says A.");
			}
			if (name === 'astara') {
	...
	{
		name: "Hackmons Cup 1v1",
		desc: ["Randomized teams of level-balanced Pok&eacute;mon with absolutely any ability, moves, and item. WITH 1v1! (by ClassyZ)"],
		section: "Randomized Metas",
